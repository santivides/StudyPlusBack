    ...
    public partial class InitialIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Courses__3214EC07FE9D62D6", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__users__3214EC0704676679", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LOrder = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Lections__3214EC07F8466D54", x => x.Id);
                    table.ForeignKey(
                        name: "fk_CourseL",
                        column: x => x.CourseId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseId = table.Column<int>(type: "int", nullable: true),
                    InscriptionDate = table.Column<DateOnly>(type: "date", nullable: true),
                    progress = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Inscript__3214EC07E824B57D", x => x.Id);
                    table.ForeignKey(
                        name: "fk_CourseI",
                        column: x => x.CourseId,
                        principalTable: "Courses",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LectionProgress", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InscriptionLP",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LectionProgress_InscriptionId",
                table: "LectionProgress",
                column: "InscriptionId");

            migrationBuilder.CreateIndex(
                name: "IX_LectionProgress_LectionId",
                table: "LectionProgress",
                column: "LectionId");
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__users__A9D105341FD7FED7",
                table: "Users",
                column: "Email",
                unique: true);
        }
